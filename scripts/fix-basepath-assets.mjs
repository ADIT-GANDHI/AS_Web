...
const ASSET_PREFIXES = [
  ...
  'people_newbg-original.png',
  'people_new_middle_white_layer.png',
  'people_new_middle_white_layer-tile.png',
  'poems-bg.png',
  'poems_newbg.png',
  'poems_newbg-tile.png',
  'poems_newbg-original.png',
  'poems-wave-divider.png',
  'poem-detail-bg.png',
